  ...
  return (
    ...
    >
      ...
      <polygon
        ...
        style={{ fill: 'url(#radar-fill)', stroke: color }}
      />
      {axes.map((a, i) => {
  ...
  switch (variant) {
    case 'river':
      return (
        ...
        >
          <path
            d="M -50 600 Q 300 540 600 600 T 1250 620 L 1250 820 L -50 820 Z"
            fill="#0a1f3a"
            opacity="0.8"
          />
          <path
            d="M -50 650 Q 300 590 600 650 T 1250 670"
            stroke="#3ddc84"
            strokeWidth="2"
            fill="none"
            opacity="0.3"
    ...
    case 'hospital':
      return (
        ...
        >
          ...
          <text x="500" y="495" fontFamily="monospace" fontSize="11" fill="#ff6ba0" opacity="0.7">
            HAPPY INDEX
          </text>
        </svg>
      )
    case 'rescue':
      return (
        ...
        >
          <polygon
            points="0,800 200,600 400,700 600,580 800,680 1000,580 1200,660 1200,800"
            fill="#2a1008"
            opacity="0.8"
          />
          <polygon
            points="0,800 200,680 450,750 700,680 900,760 1200,700 1200,800"
            fill="#1a0604"
            opacity="0.9"
          />
          {[1, 2, 3].map((i) => (
    ...
    case 'drone':
      return (
        ...
        >
          <polygon
            points="0,700 100,550 150,600 220,500 300,580 360,520 440,600 520,480 600,560 680,500 760,580 840,540 920,600 1000,520 1080,580 1200,540 1200,800 0,800"
            fill="#08102a"
            opacity="0.9"
          />
          {[
            ...
            <g key={i} transform={`translate(${d.x}, ${d.y})`}>
              ...
              <animateTransform
                ...
                type="translate"
                values={`${d.x},${d.y}; ${d.x + 20},${d.y - 10}; ${d.x},${d.y}`}
                dur={`${3 + i}s`}
                repeatCount="indefinite"
                additive="replace"
              />
    ...
    default:
      return (
        ...
        >
          ...
          <polyline
            points="380,380 420,340 460,360 500,300 540,320 580,280 620,340 660,260 700,320 740,300 780,260 820,320"
            stroke="#00e5ff"
            strokeWidth="2"
            fill="none"
            opacity="0.8"
